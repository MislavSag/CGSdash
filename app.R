...
ui = bslib::page_navbar(
  ...
  #bslib::nav_panel("VIXCombo", module_strategy_ui("vixcombo", alpha_ui_vixcombo, "https://snpmarketdata.blob.core.windows.net/descriptions/VIXCombo.html")), # alpha_ui_vixcombo
...
#  )
  output$dt_shared_returns = DT::renderDT({
    ...
    dt_ = cbind(
      ...
      #get_portfolio_stats_from_strategy(o_vixcombo()$strategy, o_vixcombo()$date, leverage_),
    ...
    tagList(
      ...
      tags$div(
        lapply(names(strategy_status), function(strat) {
          ...
          if (in_position %notin% c("FALSE", "TLT", "VIXY")) {
            # GREEN BADGE
            tags$span(
